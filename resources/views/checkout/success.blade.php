...
<head>
    ...
    <title>สั่งซื้อสำเร็จ - KCS SHOP</title>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between">
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-3xl font-extrabold text-blue-600 mt-1">฿{{ number_format($order->order_amount, 2) }}</p>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-2 text-sm">
                        ...
                        <p class="text-gray-900 font-bold tracking-wide text-base">633-213696-6</p>
                        <p class="text-gray-500">ชื่อบัญชี: น.ส.สุกัญญา ธรรมปรีชา</p>
                    </div>
                    @endif
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-6">
                ...
                <div>
                    ...
                    <div class="divide-y divide-gray-100 max-h-40 overflow-y-auto text-sm pr-1">
                        ...
                        @endforeach
                        <div class="flex justify-between py-2">
                            <span class="text-gray-600 line-clamp-1 pr-4">ค่าบริการจัดส่ง</span>
                            <span class="font-medium text-gray-800 shrink-0">฿{{ number_format($order->delivery_fee, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
